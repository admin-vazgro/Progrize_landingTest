...
export default function EditExperienceModal({ isOpen, onClose, experience, onSuccess }: EditExperienceModalProps) {
      ...
      <div className="bg-white rounded-xl max-w-lg w-full max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div className="flex items-center gap-2">
            ...
            />
            <label htmlFor="edit_is_current" className="text-sm text-gray-700">
